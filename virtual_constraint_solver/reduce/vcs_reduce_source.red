...
begin;
  ...
  debugWrite("args of {newCondTuple_, condDNF_}: ", {newCondTuple_, condDNF_});
...
begin;
  ...
  debugWrite("=== ans in convertCSToVMMain: ", ret_);
  return ret_;
end;
...
begin;
  ...
  debugWrite("=== ans in convertCSToVMIntervalMain: ", ret_);
  return ret_;
end;
