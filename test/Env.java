...
public class Env {
	...
	static public final String DIR_NAME_HYDLA = "hydla_0.5x";//ïœçXÇµÇ‹ÇµÇΩ
...
//    static private final String ENV_DEFAULT_FILE = "env.txt";//"env_default.txt";
    ...
    public Env(){
        ...
        try {
    		InputStream in = Env.getInputStreamOfFile(ENV_FILE);//ENV_DEFAULT_FILEÇ©ÇÁïœçX
        	...
        	System.err.println("read error. check "+ENV_FILE);//ENV_DEFAULT_FILEÇ©ÇÁïœçX
        }
    }
