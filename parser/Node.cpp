...
bool BinaryNode::is_same_struct(const Node& n, bool exactly_same) const
{
  ...
  if(typeid(*this) == typeid(n)) {
    // ëoï˚ÇÃéqÉmÅ[ÉhÇÃèWçáÇ™ìØàÍÇ©Ç«Ç§Ç©í≤Ç◊ÇÈ
  ...
  return false;
    ...
    // Ç±ÇÃÉmÅ[ÉhÇ™node1Ç≈ÅCî‰ärÉmÅ[ÉhÇ™node2ÇæÇ¡ÇΩèÍçá
    ...
    // Ç±ÇÃÉmÅ[ÉhÇ™node2Ç≈ÅCî‰ärÉmÅ[ÉhÇ™node1ÇæÇ¡ÇΩèÍçá
...
/// BaseNodeVisitorÇÃacceptä÷êîíËã`
