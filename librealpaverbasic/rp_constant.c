...
/* Creation of a constant c equivalent to src -ohtani- */
void rp_constant_clone(rp_constant * c, rp_constant src)
{
	rp_constant_create(c, rp_constant_name(src), rp_constant_val(src));
}
