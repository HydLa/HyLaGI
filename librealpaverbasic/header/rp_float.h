...
# define RP_ROUND_DOWNWARD()  _controlfp(_RC_DOWN, _MCW_RC)
# define RP_ROUND_UPWARD()    _controlfp(_RC_UP,   _MCW_RC)
# define RP_ROUND_NEAREST()   _controlfp(_RC_NEAR, _MCW_RC)
# define RP_MAX_DOUBLE        DBL_MAX
# define RP_MAX_LONG          LONG_MAX
# define RP_INFINITY          HUGE_VAL
