...
namespace hydla{
  namespace debug{
    ...
    std::tuple<std::vector<std::vector<std::vector<std::string>>>, std::vector<std::vector<std::string>>> Json_p::json_p(std::stringstream& sout)
    {
      value jstr;
    ...
    std::vector<std::vector<std::string>> Json_p::make_h_map(std::vector<std::vector<std::vector<std::string>>> v_ret)
    {
      std::vector<std::vector<std::string>> ret;
      std::vector<std::string> each_cons;
    ...
    std::vector<std::vector<std::vector<std::string>>> Json_p::make_vector(std::string serch_str){
      ...
      std::vector<std::string> split_str, split_str2, split_str3, split_str3_ask, split_str3_tell, cons_list;
      std::string cons;
      ...
      for(auto spl : split_str){
        ...
        boost::split(split_str3, split_str2[1], boost::is_any_of(ask_c));
