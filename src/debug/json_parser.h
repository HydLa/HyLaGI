...
public:
  ...
  json_p(std::stringstream &sout, std::string prio);
  ...
  make_vector(std::string serch_str);
  static std::vector<std::vector<std::string>>
  make_v_map(std::shared_ptr<hydla::parse_tree::ParseTree> parse_tree);
  static std::vector<std::vector<std::string>>
  make_h_map(std::vector<std::vector<std::vector<std::string>>> v_ret,
             std::map<std::string, std::vector<std::string>> p_ret);
  static std::map<std::string, std::vector<std::string>>
  make_prio_map(std::string prio);
};
} // namespace debug
} // namespace hydla
