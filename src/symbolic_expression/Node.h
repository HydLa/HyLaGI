...
public:
   ...
   * ノードの型の名前
   */
  virtual std::string get_node_type_name() const { return "Node"; }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "FactorNode"; }
};
...
public:
  ...
  UnaryNode(const node_sptr &child) : child_(child) {}

  UnaryNode(Node *child) : child_(node_sptr(child)) {}
  ...
  virtual std::string get_node_type_name() const { return "UnaryNode"; }
...
#define DEFINE_UNARY_NODE(NAME)                                                \
  ...
  public:                                                                      \
    ...
    NAME() {}                                                                  \
                                                                               \
    NAME(const node_sptr &child) : UnaryNode(child) {}                         \
    NAME(Node *child) : UnaryNode(child) {}                                    \
                                                                               \
    virtual ~NAME() {}                                                         \
                                                                               \
    ...
    virtual node_sptr clone() {                                                \
      ...
      return UnaryNode::clone(n);                                              \
                                                                               ...
                                                                               \
    virtual std::string get_node_type_name() const { return #NAME; }           \
  };
...
public:
  ...
  virtual std::string get_node_type_name() const { return "BinaryNode"; }
   ...
   */
  void set_lhs(const node_sptr &lhs) { lhs_ = lhs; }

  /**
   * getter of left-hand-side node
   */
  const node_sptr &get_lhs() const { return lhs_; }

  /**
   * setter of right-hand-side node
   */
  void set_rhs(const node_sptr &rhs) { rhs_ = rhs; }

  /**
   * getter of right-hand-side node
   */
  const node_sptr &get_rhs() const { return rhs_; }
...
protected:
  ...
  void create_child_node_list(child_node_list_t &cnl, const Node *n) const;
...
#define DEFINE_BINARY_NODE(NAME)                                               \
  ...
  public:                                                                      \
    ...
    NAME() {}                                                                  \
                                                                               \
    NAME(const node_sptr &lhs, const node_sptr &rhs) : BinaryNode(lhs, rhs) {} \
    NAME(Node *lhs, Node *rhs) : BinaryNode(node_sptr(lhs), node_sptr(rhs)) {} \
    NAME(const node_sptr &lhs, Node *rhs) : BinaryNode(lhs, node_sptr(rhs)) {} \
    NAME(Node *lhs, const node_sptr &rhs) : BinaryNode(node_sptr(lhs), rhs) {} \
                                                                               \
    virtual ~NAME() {}                                                         \
                                                                               \
    virtual void accept(node_sptr own, TreeVisitor *visitor);                  \
...
public:
  ...
  virtual std::string get_node_type_name() const { return "Caller"; }
   ...
   * @param node 実引数のノード
   */
  void add_actual_arg(const node_sptr &node) { actual_args_.push_back(node); }
   ...
   */
  node_sptr get_actual_arg(size_t index) const { return actual_args_[index]; }

  /**
   * 実引数の数を返す
   */
  size_t actual_arg_size() const { return actual_args_.size(); }

  /**
   * 束縛変数のリストの最初の要素を指す
   * 読み書き可能なiteratorを返す
   */
  actual_args_iterator actual_arg_begin() { return actual_args_.begin(); }

  /**
   * 束縛変数のリストの最初の要素を指す
   * 読み込みのみ可能なiteratorを返す
   */
  actual_args_const_iterator actual_arg_begin() const {
   ...
   * 読み書き可能なiteratorを返す
   */
  actual_args_iterator actual_arg_end() { return actual_args_.end(); }

  /**
   * 束縛変数のリストの最後の次の要素を指す
   * 読み込みのみ可能なiteratorを返す
   */
  actual_args_const_iterator actual_arg_end() const {
...
public:
  ...
  virtual std::string get_node_type_name() const { return "ConstraintCaller"; }
  virtual std::ostream &dump(std::ostream &s) const;
};
...
public:
  ...
  virtual std::string get_node_type_name() const { return "ProgramCaller"; }
  virtual std::ostream &dump(std::ostream &s) const;
};
...
public:
  ...
  virtual std::string get_node_type_name() const { return "Definition"; }
   ...
   * 束縛変数の数を返す
   */
  size_t bound_variable_size() const { return bound_variables_.size(); }

  /**
   * 束縛変数のリストの最初の要素を指す
   * 読み書き可能なiteratorを返す
   */
  bound_variables_iterator bound_variable_begin() {
   ...
   * 読み込みのみ可能なiteratorを返す
   */
  bound_variables_const_iterator bound_variable_begin() const {
    return bound_variables_.begin();
  }
   ...
   * 読み書き可能なiteratorを返す
   */
  bound_variables_iterator bound_variable_end() {
   ...
   * 読み込みのみ可能なiteratorを返す
   */
  bound_variables_const_iterator bound_variable_end() const {
    return bound_variables_.end();
  }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "ProgramDefinition"; }
};
...
public:
  ...
  virtual std::string get_node_type_name() const { return "Ask"; }

  /**
   * ガードノードを設定する
   */
  void set_guard(const node_sptr &guard) { set_lhs(guard); }

  /**
   * ガードノードを得る
   */
  const node_sptr &get_guard() const { return get_lhs(); }

  /**
   * 子ノードを設定する
   */
  void set_child(const node_sptr &child) { set_rhs(child); }

  /**
   * 子ノードを得る
   */
  const node_sptr &get_child() const { return get_rhs(); }
};

class Exists : public BinaryNode {
public:
  Exists() {}

  Exists(const node_sptr &variable, const node_sptr &child)
      : BinaryNode(variable, child) {}
  ...
  virtual node_sptr clone() {
    node_type_sptr n(new Exists);
    return BinaryNode::clone(n);
  }

  virtual std::string get_node_type_name() const { return "Exists"; }

  void set_variable(const node_sptr &variable) { set_lhs(variable); }

  const node_sptr &get_variable() const { return get_lhs(); }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "Number"; }
...
public:
  ...
  Float(double number) : number_(number) {}
  ...
  virtual std::string get_node_type_name() const { return "Float"; }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "False"; }
};
...
public:
  ...
  virtual std::string get_node_type_name() const { return "True"; }
};
...
public:
  ...
  virtual std::string get_node_type_name() const { return "Variable"; }
...
public:
  Parameter(const std::string &name, const int &differential_count,
            const int &id)
  ...
  virtual std::string get_node_type_name() const { return "Parameter"; }
  ...
  void set_differential_count(const int &dc) { differential_count_ = dc; }

  int get_differential_count() const { return differential_count_; }

  void set_phase_id(const int &id) { phase_id_ = id; }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "Infinity"; }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "SymbolicT"; }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "Print"; }
  ...
  void set_args(const std::string &str) { args_ = str; }

  std::string get_args() const { return args_; }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "PrintPP"; }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "PrintIP"; }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "Scan"; }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "Exit"; }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "Abort"; }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "$timer"; }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "VariadicNode"; }
...
public:
  ...
  Range(const node_sptr &lhs, const node_sptr &rhs) : BinaryNode(lhs, rhs) {}
  ...
  virtual std::string get_node_type_name() const { return "Range"; }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "ProgramListCaller"; }
  virtual std::ostream &dump(std::ostream &s) const;
};
...
public:
  ...
  virtual std::string get_node_type_name() const { return "ExpressionList"; }
...
public:
  ...
  virtual std::string get_node_type_name() const { return "ProgramList"; }
...
public:
  ...
  Function(const std::string &str) : name_(str) {}
  ...
  virtual std::string get_node_type_name() const { return "Function"; }
...
public:
  ...
  UnsupportedFunction(const std::string &str) : name_(str) {}
