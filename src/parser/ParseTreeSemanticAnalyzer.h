...
private:
  ...
  std::set<std::shared_ptr<symbolic_expression::ConstraintDefinition>>
      unused_constraint_definition;
  std::set<std::shared_ptr<symbolic_expression::ProgramDefinition>>
  ...
  apply_definition(const referenced_definition_t &def_type,
