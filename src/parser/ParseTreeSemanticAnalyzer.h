...
class ParseTreeSemanticAnalyzer : public symbolic_expression::TreeVisitor {
public:
...
private:
  ...
  // Exists
  virtual void visit(boost::shared_ptr<symbolic_expression::Exists> node);
  ...
  virtual void
  visit(boost::shared_ptr<symbolic_expression::ImaginaryUnit> node);
  ...
  // ExpressionList
  virtual void
  visit(boost::shared_ptr<symbolic_expression::ExpressionList> node);

  // ConditionalExpressionList
  virtual void
  visit(boost::shared_ptr<symbolic_expression::ConditionalExpressionList> node);
  ...
  virtual void
  visit(boost::shared_ptr<symbolic_expression::ConditionalProgramList> node);
  ...
  // DifferentVariable
  virtual void
  visit(boost::shared_ptr<symbolic_expression::DifferentVariable> node);

  // ExpressionListElement
  virtual void
  visit(boost::shared_ptr<symbolic_expression::ExpressionListElement> node);

  // ExpressionListCaller
  virtual void
  visit(boost::shared_ptr<symbolic_expression::ExpressionListCaller> node);

  // ExpressionListDefinition
  virtual void
  visit(boost::shared_ptr<symbolic_expression::ExpressionListDefinition> node);

  // ProgramListDefinition
  virtual void
  visit(boost::shared_ptr<symbolic_expression::ProgramListDefinition> node);

  // ProgramListCaller
  virtual void
  visit(boost::shared_ptr<symbolic_expression::ProgramListCaller> node);

  // ProgramListElement
  virtual void
  visit(boost::shared_ptr<symbolic_expression::ProgramListElement> node);
  ...
  typedef parser::DefinitionContainer<symbolic_expression::Definition>::
      definition_map_key_t referenced_definition_t;

  typedef std::set<referenced_definition_t> referenced_definition_list_t;

  typedef std::map<std::string, symbolic_expression::node_sptr>
      formal_arg_map_t;
  ...
  std::set<boost::shared_ptr<symbolic_expression::ConstraintDefinition>>
      unused_constraint_definition;
  std::set<boost::shared_ptr<symbolic_expression::ProgramDefinition>>
      unused_program_definition;
  std::set<boost::shared_ptr<symbolic_expression::ExpressionListDefinition>>
      unused_expression_list_definition;
  std::set<boost::shared_ptr<symbolic_expression::ProgramListDefinition>>
      unused_program_list_definition;
