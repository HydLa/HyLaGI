...
public:
  ...
  boost::shared_ptr<symbolic_expression::ExpressionList> expand_list(
      boost::shared_ptr<symbolic_expression::ConditionalExpressionList>);
  boost::shared_ptr<symbolic_expression::ProgramList> expand_list(
      boost::shared_ptr<symbolic_expression::ConditionalProgramList>);
  boost::shared_ptr<symbolic_expression::VariadicNode>
      expand_list(boost::shared_ptr<symbolic_expression::Range>);
  boost::shared_ptr<symbolic_expression::VariadicNode>
      expand_list(boost::shared_ptr<symbolic_expression::Union>);
  boost::shared_ptr<symbolic_expression::VariadicNode>
      expand_list(boost::shared_ptr<symbolic_expression::Intersection>);
  symbolic_expression::node_sptr expand_list(
      boost::shared_ptr<symbolic_expression::ExpressionListElement>);
  symbolic_expression::node_sptr
      expand_list(boost::shared_ptr<symbolic_expression::ProgramListElement>);
  boost::shared_ptr<symbolic_expression::Number>
      expand_list(boost::shared_ptr<symbolic_expression::SizeOfList>);
  symbolic_expression::node_sptr
      expand_list(boost::shared_ptr<symbolic_expression::SumOfList>);
  symbolic_expression::node_sptr
      expand_list(boost::shared_ptr<symbolic_expression::MulOfList>);
  ...
  virtual void
      visit(boost::shared_ptr<symbolic_expression::ExpressionListDefinition>);
  ...
  virtual void
      visit(boost::shared_ptr<symbolic_expression::ProgramListDefinition>);
  virtual void visit(boost::shared_ptr<symbolic_expression::PrintIP>);
  virtual void
      visit(boost::shared_ptr<symbolic_expression::ConstraintDefinition>);
  ...
  virtual void
      visit(boost::shared_ptr<symbolic_expression::UnsupportedFunction>);
  ...
  virtual void visit(boost::shared_ptr<symbolic_expression::Exists>);
  ...
  virtual void
      visit(boost::shared_ptr<symbolic_expression::ConditionalExpressionList>);
  virtual void
      visit(boost::shared_ptr<symbolic_expression::ConditionalProgramList>);
  ...
  virtual void
      visit(boost::shared_ptr<symbolic_expression::ExpressionListElement>);
  virtual void
      visit(boost::shared_ptr<symbolic_expression::ProgramListElement>);
  virtual void visit(boost::shared_ptr<symbolic_expression::ProgramListCaller>);
  virtual void
      visit(boost::shared_ptr<symbolic_expression::ExpressionListCaller>);
  ...
  std::set<boost::shared_ptr<symbolic_expression::ExpressionListDefinition>>
  get_called_expression_list_definition();
  std::set<boost::shared_ptr<symbolic_expression::ProgramListDefinition>>
  get_called_program_list_definition();

private:
  void
  expand_conditional_list(boost::shared_ptr<symbolic_expression::VariadicNode>,
                          symbolic_expression::node_sptr,
                          boost::shared_ptr<symbolic_expression::VariadicNode>,
                          int);
