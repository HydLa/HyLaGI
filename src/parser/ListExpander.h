...
public:
  ...
  std::shared_ptr<symbolic_expression::ExpressionList> expand_list(std::shared_ptr<symbolic_expression::ConditionalExpressionList>);
  std::shared_ptr<symbolic_expression::ProgramList> expand_list(std::shared_ptr<symbolic_expression::ConditionalProgramList>);
  std::shared_ptr<symbolic_expression::VariadicNode> expand_list(std::shared_ptr<symbolic_expression::Range>);
  std::shared_ptr<symbolic_expression::VariadicNode> expand_list(std::shared_ptr<symbolic_expression::Union>);
  std::shared_ptr<symbolic_expression::VariadicNode> expand_list(std::shared_ptr<symbolic_expression::Intersection>);
  symbolic_expression::node_sptr expand_list(std::shared_ptr<symbolic_expression::ExpressionListElement>);
  symbolic_expression::node_sptr expand_list(std::shared_ptr<symbolic_expression::ProgramListElement>);
  std::shared_ptr<symbolic_expression::Number> expand_list(std::shared_ptr<symbolic_expression::SizeOfList>);
  symbolic_expression::node_sptr expand_list(std::shared_ptr<symbolic_expression::SumOfList>);
  symbolic_expression::node_sptr expand_list(std::shared_ptr<symbolic_expression::MulOfList>);
  ...
  virtual void visit(std::shared_ptr<symbolic_expression::ExpressionListDefinition>);
  ...
  virtual void visit(std::shared_ptr<symbolic_expression::ProgramListDefinition>);
  virtual void visit(std::shared_ptr<symbolic_expression::PrintIP>);
  virtual void visit(std::shared_ptr<symbolic_expression::ConstraintDefinition>);
  ...
  virtual void visit(std::shared_ptr<symbolic_expression::ConditionalExpressionList>);
  virtual void visit(std::shared_ptr<symbolic_expression::ConditionalProgramList>);
  ...
  virtual void visit(std::shared_ptr<symbolic_expression::ExpressionListElement>);
  ...
  virtual void visit(std::shared_ptr<symbolic_expression::ExpressionListCaller>);
  ...
  std::set<std::shared_ptr<symbolic_expression::ExpressionListDefinition> >  get_called_expression_list_definition();
  std::set<std::shared_ptr<symbolic_expression::ProgramListDefinition> >  get_called_program_list_definition();
private:
  void expand_conditional_list(std::shared_ptr<symbolic_expression::VariadicNode>, symbolic_expression::node_sptr, std::shared_ptr<symbolic_expression::VariadicNode>, int);

  bool in_list_element = false;

  std::stack<std::set<referenced_definition_t> > referenced_definition;

  std::set<std::shared_ptr<symbolic_expression::ExpressionListDefinition> >  called_expression_list_definition;
  std::set<std::shared_ptr<symbolic_expression::ProgramListDefinition> >  called_program_list_definition;
