...
// コマンド文
void Backend::visit(std::shared_ptr<symbolic_expression::PrintPP> node) {
  link_->put_symbol("True");
}
void Backend::visit(std::shared_ptr<symbolic_expression::PrintIP> node) {
  link_->put_symbol("True");
}
void Backend::visit(std::shared_ptr<symbolic_expression::Scan> node) {
  link_->put_symbol("True");
}

void Backend::visit(std::shared_ptr<symbolic_expression::True> node) {
  link_->put_symbol("True");
}
void Backend::visit(std::shared_ptr<symbolic_expression::False> node) {
...
void Backend::visit(
  ...
  std::shared_ptr<symbolic_expression::ExpressionList> el =
      std::dynamic_pointer_cast<symbolic_expression::ExpressionList>(
          node->get_lhs());
