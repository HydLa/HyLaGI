...
ModuleSetContainer::module_set_set_t ModuleSetContainer::get_full_ms_list()const{
...
void ModuleSetContainer::generate_new_ms(const module_set_set_t& mms, const ModuleSet& ms){
