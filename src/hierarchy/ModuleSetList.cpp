...
ModuleSetList::ModuleSetList(ModuleSet m) : ModuleSetContainer(m) {}
...
void ModuleSetList::add_required_parallel(
    ModuleSetList &parallel_module_set_list) {
  // 空のモジュール集合の集合を用意
...
void ModuleSetList::remove_included_ms_by_current_ms() { ms_to_visit_.clear(); }
