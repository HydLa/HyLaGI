...
find_min_time_result_t calculate_tmp_result(phase_result_sptr_t& phase,value_t time_limit,  symbolic_expression::node_sptr trigger,backend::Backend* backend_, variable_map_t vm_before_time_shift);
} //namespace simulator
} //namespace hydla
