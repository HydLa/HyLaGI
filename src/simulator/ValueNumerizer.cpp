...
void ValueNumerizer::visit(shared_ptr<Function> node)
{
  ...
  if(name == "sin")
  {
    ...
    if(fully_numerized)current_double = sin(current_double);
    else
    {
  ...
  else if(name == "cos")
  {
    ...
    accept(node->get_argument(0));
    if(fully_numerized)current_double = cos(current_double);
    else
    {
      shared_ptr<Function> new_node(new Function(name));
      new_node->add_argument(current_value.get_node());
  ...
  else if(name == "tan")
  {
    ...
    accept(node->get_argument(0));
    if(fully_numerized)current_double = tan(current_double);
    else
    {
      shared_ptr<Function> new_node(new Function(name));
      new_node->add_argument(current_value.get_node());
  ...
  else if(name == "log")
  {
    ...
    accept(node->get_argument(0));
    if(fully_numerized)current_double = log(current_double);
    else
    {
      shared_ptr<Function> new_node(new Function(name));
      new_node->add_argument(current_value.get_node());
