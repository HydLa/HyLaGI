...
public:
  ...
  virtual void
  visit(boost::shared_ptr<hydla::symbolic_expression::Positive> node);

  virtual void
  visit(boost::shared_ptr<hydla::symbolic_expression::Differential> node);

  virtual void
  visit(boost::shared_ptr<hydla::symbolic_expression::Function> node);
  virtual void visit(
      boost::shared_ptr<hydla::symbolic_expression::UnsupportedFunction> node);
  ...
  virtual void
  visit(boost::shared_ptr<hydla::symbolic_expression::Parameter> node);
  virtual void
  visit(boost::shared_ptr<hydla::symbolic_expression::SymbolicT> node);
  virtual void
  visit(boost::shared_ptr<hydla::symbolic_expression::Infinity> node);
  virtual void
  visit(boost::shared_ptr<hydla::symbolic_expression::SVtimer> node);
