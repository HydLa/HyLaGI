...
find_min_time_result_t MinTimeCalculator::calculate_min_time(guard_time_map_t *g, const constraint_t &guard, bool negated, value_t time_limit, const constraint_t &time_bound, value_t starting_time)
{
  guard_time_map = g;
