...
ValueRange ValueModifier::apply_function(const std::string &function,
                                         const Value &time,
...
variable_map_t ValueModifier::substitute_time(const Value &time,
                                              const variable_map_t &map) {
  return apply_function("applyTime2Expr", time, map);
}

ValueRange ValueModifier::substitute_time(const Value &time,
                                          const ValueRange &range) {
...
ValueRange ValueModifier::shift_time(const Value &time,
                                     const ValueRange &range) {
  return apply_function("exprTimeShift", time, range);
}

variable_map_t ValueModifier::shift_time(const Value &time,
                                         const variable_map_t &map) {
