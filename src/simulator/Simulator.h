...
public:
  bool operator()(const phase_result_sptr_t &lhs,
...
public:
   ...
   * @param ps a pointer to an instance of phase_simlulator_t (caller must not
   * delete the instance)
   */
   ...
   */
  parameter_t introduce_parameter(const variable_t &var,
                                  const PhaseResult &phase,
                                  const ValueRange &range);
  parameter_t introduce_parameter(const std::string &name, int differential_cnt,
                                  int id, const ValueRange &range);
  parameter_t introduce_parameter(const parameter_t &par,
                                  const ValueRange &range);
