 ...
 * type of a phase
 */
typedef enum { InvalidPhase, POINT_PHASE, INTERVAL_PHASE } PhaseType;
...
typedef std::shared_ptr<hierarchy::ModuleSetContainer>
    module_set_container_sptr;
...
struct DCCandidate {
  ...
  DCCandidate(const value_t &t, const std::map<ask_t, bool> &d,
