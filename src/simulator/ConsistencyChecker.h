...
public:
  ...
  CheckConsistencyResult check_consistency(RelationGraph &relation_graph, ConstraintStore &diff_constraints, const std::list<Variable> &discrete_variables, const PhaseType& phase, profile_t &profile);
