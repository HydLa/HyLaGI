...
class LTLNode : public AutomatonNode
{
 public:
  ...
  LTLNode(hydla::simulator::phase_result_sptr_t set_phase,PropertyNode* set_property,int id);
  LTLNode(std::string name,hydla::simulator::phase_result_sptr_t set_phase,PropertyNode* set_property,int id);
  /* ~LTLNode(); */
